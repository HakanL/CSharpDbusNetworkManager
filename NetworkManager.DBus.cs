...
namespace NetworkManager.DBus
{
    ...
    {
        Task<IDictionary<IDevice, IDictionary<string, IDictionary<string, object>>>> GetManagedObjectsAsync();
        Task<IDisposable> WatchInterfacesAddedAsync(Action<(IDevice IDevice, IDictionary<string, IDictionary<string, object>> interfacesAndProperties)> handler, Action<Exception> onError = null);
        Task<IDisposable> WatchInterfacesRemovedAsync(Action<(IDevice IDevice, string[] interfaces)> handler, Action<Exception> onError = null);
    }
    ...
    interface INetworkManager : IDBusObject
    {
        ...
        Task<IDevice> ActivateConnectionAsync(IDevice Connection, IDevice Device, IDevice SpecificObject);
        Task<(IDevice path, IDevice activeConnection)> AddAndActivateConnectionAsync(IDictionary<string, IDictionary<string, object>> Connection, IDevice Device, IDevice SpecificObject);
        Task<(IDevice path, IDevice activeConnection, IDictionary<string, object> result)> AddAndActivateConnection2Async(IDictionary<string, IDictionary<string, object>> Connection, IDevice Device, IDevice SpecificObject, IDictionary<string, object> Options);
        Task DeactivateConnectionAsync(IDevice ActiveConnection);
        ...
        Task<DeviceState> CheckConnectivityAsync();
        Task<DeviceState> stateAsync();
        Task<IDevice> CheckpointCreateAsync(IDevice[] Devices, uint RollbackTimeout, uint Flags);
        Task CheckpointDestroyAsync(IDevice Checkpoint);
        Task<IDictionary<string, uint>> CheckpointRollbackAsync(IDevice Checkpoint);
        Task CheckpointAdjustRollbackTimeoutAsync(IDevice Checkpoint, uint AddTimeout);
        Task<IDisposable> WatchCheckPermissionsAsync(Action handler, Action<Exception> onError = null);
        Task<IDisposable> WatchStateChangedAsync(Action<DeviceState> handler, Action<Exception> onError = null);
        Task<IDisposable> WatchDeviceAddedAsync(Action<IDevice> handler, Action<Exception> onError = null);
        Task<IDisposable> WatchDeviceRemovedAsync(Action<IDevice> handler, Action<Exception> onError = null);
    ...
    {
        private IDevice[] _Devices = default(IDevice[]);
        ...
        private IDevice[] _AllDevices = default(IDevice[]);
        public IDevice[] AllDevices
        {
            get
            {
                return _AllDevices;
        ...
        private IDevice[] _Checkpoints = default(IDevice[]);
        public IDevice[] Checkpoints
        {
            get
            {
                return _Checkpoints;
        ...
        private IDevice[] _ActiveConnections = default(IDevice[]);
        public IDevice[] ActiveConnections
        {
            get
            {
        ...
        private IDevice _PrimaryConnection = default(IDevice);
        public IDevice PrimaryConnection
        {
            get
            {
        ...
        private IDevice _ActivatingConnection = default(IDevice);
        public IDevice ActivatingConnection
        {
            get
            {
    ...
    {
        public static Task<IDevice[]> GetDevicesAsync(this INetworkManager o) => o.GetAsync<IDevice[]>("Devices");
        public static Task<IDevice[]> GetAllDevicesAsync(this INetworkManager o) => o.GetAsync<IDevice[]>("AllDevices");
        public static Task<IDevice[]> GetCheckpointsAsync(this INetworkManager o) => o.GetAsync<IDevice[]>("Checkpoints");
        ...
        public static Task<IConnection[]> GetActiveConnectionsAsync(this INetworkManager o) => o.GetAsync<IConnection[]>("ActiveConnections");
        ...
        public static Task<IDevice> GetActivatingConnectionAsync(this INetworkManager o) => o.GetAsync<IDevice>("ActivatingConnection");
    ...
    {
        Task<IDisposable> WatchStateChangedAsync(Action<(DeviceState state, DeviceState reason)> handler, Action<Exception> onError = null);
        Task<T> GetAsync<T>(string prop);
    ...
    {
        private IDevice _Connection = default(IDevice);
        public IDevice Connection
        {
            get
            {
                return _Connection;
        ...
        private IDevice _SpecificObject = default(IDevice);
        public IDevice SpecificObject
        {
            get
            {
        ...
        private IDevice _Ip4Config = default(IDevice);
        public IDevice Ip4Config
        {
            get
            {
                return _Ip4Config;
        ...
        private IDevice _Dhcp4Config = default(IDevice);
        public IDevice Dhcp4Config
        {
            get
            {
                return _Dhcp4Config;
        ...
        private IDevice _Ip6Config = default(IDevice);
        public IDevice Ip6Config
        {
            get
            {
                return _Ip6Config;
        ...
        private IDevice _Dhcp6Config = default(IDevice);
        public IDevice Dhcp6Config
        {
            get
            {
                return _Dhcp6Config;
        ...
        private IDevice _Master = default(IDevice);
    ...
    {
        public static Task<IDevice> GetConnectionAsync(this IActive o) => o.GetAsync<IDevice>("Connection");
        public static Task<IDevice> GetSpecificObjectAsync(this IActive o) => o.GetAsync<IDevice>("SpecificObject");
        ...
        public static Task<IDevice[]> GetDevicesAsync(this IActive o) => o.GetAsync<IDevice[]>("Devices");
        ...
        public static Task<IDevice> GetIp4ConfigAsync(this IActive o) => o.GetAsync<IDevice>("Ip4Config");
        public static Task<IDevice> GetDhcp4ConfigAsync(this IActive o) => o.GetAsync<IDevice>("Dhcp4Config");
        public static Task<bool> GetDefault6Async(this IActive o) => o.GetAsync<bool>("Default6");
        public static Task<IDevice> GetIp6ConfigAsync(this IActive o) => o.GetAsync<IDevice>("Ip6Config");
        public static Task<IDevice> GetDhcp6ConfigAsync(this IActive o) => o.GetAsync<IDevice>("Dhcp6Config");
        public static Task<bool> GetVpnAsync(this IActive o) => o.GetAsync<bool>("Vpn");
        public static Task<IDevice> GetMasterAsync(this IActive o) => o.GetAsync<IDevice>("Master");
    }
    ...
    class DeviceProperties
    {
        ...
        private IDevice _ActiveConnection = default(IDevice);
        public IDevice ActiveConnection
        {
            get
            {
        ...
        private IDevice[] _AvailableConnections = default(IDevice[]);
        public IDevice[] AvailableConnections
        {
            get
            {
    ...
    static class DeviceExtensions
    {
        ...
        public static Task<IDevice> GetActiveConnectionAsync(this IDevice o) => o.GetAsync<IDevice>("ActiveConnection");
        public static Task<IIP4Config> GetIp4ConfigAsync(this IDevice o) => o.GetAsync<IIP4Config>("Ip4Config");
        public static Task<IDHCP4Config> GetDhcp4ConfigAsync(this IDevice o) => o.GetAsync<IDHCP4Config>("Dhcp4Config");
        public static Task<IIP6Config> GetIp6ConfigAsync(this IDevice o) => o.GetAsync<IIP6Config>("Ip6Config");
        public static Task<IDevice> GetDhcp6ConfigAsync(this IDevice o) => o.GetAsync<IDevice>("Dhcp6Config");
        ...
        public static Task<IDevice[]> GetAvailableConnectionsAsync(this IDevice o) => o.GetAsync<IDevice[]>("AvailableConnections");
    ...
    class BridgeProperties
    {
        ...
        private IDevice[] _Slaves = default(IDevice[]);
        public IDevice[] Slaves
        {
            get
            {
                return _Slaves;
    ...
    static class BridgeExtensions
    {
        ...
        public static Task<IDevice[]> GetSlavesAsync(this IBridge o) => o.GetAsync<IDevice[]>("Slaves");
    }
    ...
    {
        Task<IDevice[]> ListConnectionsAsync();
        Task<IDevice> GetConnectionByUuidAsync(string Uuid);
        Task<IDevice> AddConnectionAsync(IDictionary<string, IDictionary<string, object>> Connection);
        Task<IDevice> AddConnectionUnsavedAsync(IDictionary<string, IDictionary<string, object>> Connection);
        Task<(IDevice path, IDictionary<string, object> result)> AddConnection2Async(IDictionary<string, IDictionary<string, object>> Settings, uint Flags, IDictionary<string, object> Args);
        ...
        Task<IDisposable> WatchNewConnectionAsync(Action<IDevice> handler, Action<Exception> onError = null);
        Task<IDisposable> WatchConnectionRemovedAsync(Action<IDevice> handler, Action<Exception> onError = null);
        Task<T> GetAsync<T>(string prop);
    ...
    {
        private IDevice[] _Connections = default(IDevice[]);
        public IDevice[] Connections
        {
            get
            {
                return _Connections;
    ...
    {
        public static Task<IDevice[]> GetConnectionsAsync(this ISettings o) => o.GetAsync<IDevice[]>("Connections");
